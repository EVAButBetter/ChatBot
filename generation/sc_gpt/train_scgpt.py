...
from transformers import AutoTokenizer, AutoModelForCausalLM, WEIGHTS_NAME, AdamW, get_linear_schedule_with_warmup
...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained("igorktech/sc-gpt-upf")
    model = AutoModelForCausalLM.from_pretrained("igorktech/sc-gpt-upf")
